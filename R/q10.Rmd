...
```{r 10.a, warnings=FALSE, message=FALSE}
```
...
```{r 10.b, warnings=FALSE, message=FALSE}
```
...
```{r 10.c, warnings=FALSE, message=FALSE}
```
...
**(f)** Do part (a)–(e) but now for the variable agegrp. What are your conclusions regarding the assumption of proportional hazards? No written solutions for this part.

No written solutions for this part.
